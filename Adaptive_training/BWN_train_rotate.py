...
onn_out_type = 'shiftRight_phaseNoise_0.26pi_rotate-5'
...
ckpt_restore_dir = './ckpt_bwn/shiftRight_phaseNoise_0.26pi_start-lr_0.02_step_1200_rate_0.9/'
restore = True
Train = True
...
W_fc1 = tf.clip_by_value(W_fc1, -5, 5)
